...
export class KaizenStatusReportComponent implements OnInit{
    ...
    this.fromKaizenStatus = this.fb.group(
      {
        ...
        PlantId: ['2F9887FA-609D-4106-AED9-4684EDCB33C5', Validators.required],
        ReportType:['KaizenStatus',Validators.required]
      })
  }
  ngOnInit(){
  ...
  async TopKaizenStatus(Action:string){
    ...
    if(this.fromKaizenStatus.controls["ReportType"].value==='KaizenStatus')
    {
      // alert("0")
    ...
    this.objReport.report_parameters = {
      ...
      UserId: this.UserId,
      Action: this.fromKaizenStatus.controls["ReportType"].value
    };
